...
class Plano(models.Model):
    ...
    inicio_prazo = models.DateField(default=timezone.now)
    ...
    def clean(self):
        if self.categoria not in dict(self.CATEGORIAS_CHOICES):
            raise ValidationError(f"Categoria '{self.categoria}' inválida.")
